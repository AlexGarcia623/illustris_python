...
#     snapPath = basePath + '/snapdir_' + str(snapNum).zfill(3) + '/' # TNG50
#     snapPath = basePath + '/snapshot_' + str(snapNum).zfill(3) + '/' # TNG100 - Snapshot 99 
    snapPath = basePath + '/snapdir_' + str(snapNum).zfill(3) + '/' # Illustris
