...
def offsetPath(basePath, snapNum):
    ...
    offsetPath = basePath + '/postprocessing/offsets/offsets_%03d.hdf5'    % snapNum # TNG
    # offsetPath = basePath + '/../postprocessing/offsets/offsets_%03d.hdf5' % snapNum # Illustris
    
#     offsetPath = basePath + '/postprocessing/offsets/offsets/offsets_%03d.hdf5' % snapNum # TNG100-1 is stupid ??
    return offsetPath
